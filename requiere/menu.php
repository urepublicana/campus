    ...
    <div class="navbar navbar-inverse navbar-fixed-top <?php echo $style; ?>" id="menu_nav">
      <div class="container" id="menu_bar">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">
            <img title="<?php echo $pagina; ?>" id="logo_virtual" src="<?php echo $imagen; ?>" ></a>
        </div>

        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            <li>
              <a onclick="mostrar_nav()">
                <img id='notifica_nav' class="pulse ocultar" src="../imgs/advertencia.png">
              </a>   
            </li>
      ...
      <div id='mostrar_navegadores' class="ocultar">
      <h5><b>Te recomendamos navegar en Firefox o Google Chrome</b></h5>
      </div>
      </div>
    </div>