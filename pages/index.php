  ...
  <body>
	...
	<div id="headerwrap">
		...
		<div class="texto_banner centered">
			<h2 id="frase1">Formamos más Colombianos <br></h2>
			<h2 id="frase2">ética, social y cientificamente</h2>
			<!--
	...
	<div class="container centered w">
		...
		//obtener un array asociativo
				while ($row = $resultado->fetch_assoc()) {
					$aux++;
					$resumen = substr($row['resumen'], 0, 100)."...";
					print("
		...
		<div id="dg">
			<div class="row centered">
				...
				<div class='col-lg-4' id='elem_1'>
					...
					<p class="autor-testimonio"><img class="img-circle" src="../admin/imgs_news/pic1.jpg">José Luis López Yepes<br>Estudiante</p>
				</div>
				...
				<div class='col-lg-4' id='elem_2'>
					...
					<div class="fecha-abajo"></div>
					<p class="autor-testimonio"><img class="img-circle" src="../admin/imgs_news/pic2.jpg">Mayra Jenny Trujillo Nuñez<br>Estudiante</p>
				</div>
				...
				<div class='col-lg-4' id='elem_3'>
					...
					<div class="fecha-abajo"></div>
					<p class="autor-testimonio"><img class="img-circle" src="../admin/imgs_news/pic3.jpg">Aida Esperanza Pachon<br>Estudiante</p>
				</div>
